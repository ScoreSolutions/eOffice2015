<%@ Page ValidateRequest="false" Language="C#" MasterPageFile="Layout.Master" AutoEventWireup="true" CodeBehind="frmsmtp.aspx.cs" Inherits="CScharpDemo.frmsmtp" %>

		<asp:Content runat="server" ContentPlaceHolderID="container">
            <h1>ActiveXperts Email Component - ASP .NET C# SMTP</h1>
			<hr />
			<p>
