...
Partial Class UserControls_txtDate
    ...
    Public ReadOnly Property GetDateCondition() As String
        ...
        End Get
    End Property
    Public ReadOnly Property GetDateToSave() As String
        Get
            Dim ret As String = ""
            If txtdate.Text.Trim() <> "" Then
                If GetDate.Year > 2500 Then
                    ret = "'" & (GetDate.Year - 543) & "-" & GetDate().ToString("MM-dd") & "'"
                Else
                    ret = "'" & GetDate.Year & "-" & GetDate().ToString("MM-dd") & "'"
                End If
            Else
                ret = "NULL"
            End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            txtdate.Attributes.Add("OnMouseDown", "return ValidRightClick(event)")
