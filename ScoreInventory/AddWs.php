...
<?php
    ...
    $ws_code=$_REQUEST['txtWScode'];
    $ws_code= iconv("UTF-8","tis-620", $ws_code);  
    $ws_name=$_REQUEST['txtWSname'];
    $ws_name= iconv("UTF-8","tis-620", $ws_name);
    $ws_status=$_REQUEST['WScheck'];
    $ws_remark=$_REQUEST['optRemark'];
    ...
    {
            $sql = "INSERT INTO M_WAREHOUSE (CreateBy,CreateDate,ws_code,ws_name,remark_id,active_status) 
                VALUES ('$name2',GETDATE(),'$ws_code','$ws_name','$ws_remark','$ws_status')";
