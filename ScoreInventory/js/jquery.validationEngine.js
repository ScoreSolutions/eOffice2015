...
jQuery.fn.validationEngine = function(settings) {
	if($.validationEngineLanguage){					// IS THERE A LANGUAGE LOCALISATION ?
		...
		allRules = {"required":{    			  // Add your regex rules here, you can take telephone as an example
							"regex":"none",
							"alertText":"* โปรดกรอกข้อมูลให้ครบถ้วน",
							"alertTextCheckboxMultiple":"* โปรดเลือกข้อมูล",
							"alertTextCheckboxe":"* This checkbox is required"},
						"length":{
							"regex":"none",
							"alertText":"* รหัสผ่านมีจำนวน ",
							"alertText2":" ถึง ",
							"alertText3": " ตัวขึ้นไป"},
						"minCheckbox":{
							"regex":"none",
						...
						"email":{
							...
							"alertText":"* โปรดกรอก Email เท่านั้น"},	
						"date":{
                             "regex":"/^[0-9]{4}\-\[0-9]{1,2}\-\[0-9]{1,2}$/",
                             "alertText":"* Invalid date, must be in YYYY-MM-DD format"},
						"onlyNumber":{
							"regex":"/^[0-9]+$/",
							"alertText":"* กรอกเป็นจำนวนตัวเลขเท่านั้น"},	
						"noSpecialCaracters":{
							"regex":"/^[0-9a-zA-Z]+$/",
