...
Namespace Table
    'Represents a transaction for ISSUE_LOG_ATTACH_FILE table DAL.
    '[Create by  on March, 19 2011]
    Public Class IssueLogAttachFileDAL
        Public Sub IssueLogAttachFileDAL()

        End Sub
        ' ISSUE_LOG_ATTACH_FILE
        Const _tableName As String = "TRACKINGLOG_ISSUE_LOG_ATTACH_FILE"
        ...
        '/// Returns an indication whether the current data is inserted into ISSUE_LOG_ATTACH_FILE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to ISSUE_LOG_ATTACH_FILE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from ISSUE_LOG_ATTACH_FILE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of ISSUE_LOG_ATTACH_FILE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of ISSUE_LOG_ATTACH_FILE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(ByVal cid As Long, ByVal trans As SQLTransaction) As IssueLogAttachFileData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if update data successfully; otherwise, false.</returns>
        Public Function UpdateByFILE_NAME(ByVal cFILE_NAME As String, ByVal UserID As String, ByVal trans As SQLTransaction) As Boolean
            _UPDATE_BY = UserID
            _UPDATE_ON = DateTime.Now
            Return doUpdate("FILE_NAME = " & DB.SetString(cFILE_NAME) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if delete data successfully; otherwise, false.</returns>
        Public Function DeleteByFILE_NAME(ByVal cFILE_NAME As String, ByVal trans As SQLTransaction) As Boolean
            Return doDelete("FILE_NAME = " & DB.SetString(cFILE_NAME) & " ", trans)
        End Function


        '/// Returns an indication whether the record of ISSUE_LOG_ATTACH_FILE by specified FILE_NAME key is retrieved successfully.
        '/// <param name=cFILE_NAME>The FILE_NAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByFILE_NAME(ByVal cFILE_NAME As String, ByVal trans As SQLTransaction) As Boolean
            Return doChkData("FILE_NAME = " & DB.SetString(cFILE_NAME) & " ", trans)
        End Function

        '/// Returns an indication whether the Data Class of ISSUE_LOG_ATTACH_FILE by specified FILE_NAME key is retrieved successfully.
        '/// <param name=cFILE_NAME>The FILE_NAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByFILE_NAME(ByVal cFILE_NAME As String, ByVal trans As SQLTransaction) As IssueLogAttachFileData
            Return doGetMappingData("FILE_NAME = " & DB.SetString(cFILE_NAME) & " ", trans)
        End Function

        '/// Returns an indication whether the record of ISSUE_LOG_ATTACH_FILE by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("issue_tracking_log_id")) = False Then _issue_tracking_log_id = Convert.ToInt64(Rdr("issue_tracking_log_id"))
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of ISSUE_LOG_ATTACH_FILE by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As IssueLogAttachFileData, ByVal RDr As DataRow) As IssueLogAttachFileData
            ...
            If Convert.IsDBNull(Rdr("issue_tracking_log_id")) = False Then ret.ISSUE_TRACKING_LOG_ID = Convert.ToInt64(Rdr("issue_tracking_log_id"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As IssueLogAttachFileData
            ClearData()
            _haveData = False
            Dim ret As New IssueLogAttachFileData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table ISSUE_LOG_ATTACH_FILE
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, CREATE_BY, CREATE_ON, UPDATE_BY, UPDATE_ON, ISSUE_TRACKING_LOG_ID, FILE_NAME, FILE_DESC, FILE_EXTENTION)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_ISSUE_TRACKING_LOG_ID) & ", "
        ...
        'Get update statement form table ISSUE_LOG_ATTACH_FILE
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "ISSUE_TRACKING_LOG_ID = " & DB.SetDouble(_ISSUE_TRACKING_LOG_ID) & ", "
        ...
        'Get Delete Record in table ISSUE_LOG_ATTACH_FILE
        ...
        'Get Select Statement for table ISSUE_LOG_ATTACH_FILE
