...
Namespace Table
    'Represents a transaction for LOG_STATUS table DAL.
    '[Create by  on March, 8 2011]
    Public Class LogStatusDAL
        Public Sub LogStatusDAL()

        End Sub
        ' LOG_STATUS
        Const _tableName As String = "TRACKINGLOG_LOG_STATUS"
        ...
        '/// Returns an indication whether the current data is inserted into LOG_STATUS table successfully.
        ...
        '/// Returns an indication whether the current data is updated to LOG_STATUS table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from LOG_STATUS table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of LOG_STATUS by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of LOG_STATUS by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(ByVal cid As Long, ByVal trans As SQLTransaction) As LogStatusData
        ...
        '/// Returns an indication whether the record of LOG_STATUS by specified STATUS_NAME key is retrieved successfully.
        ...
        '/// Returns an indication whether the Data Class of LOG_STATUS by specified STATUS_NAME key is retrieved successfully.
        '/// <param name=cSTATUS_NAME>The STATUS_NAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataBySTATUS_NAME(ByVal cSTATUS_NAME As String, ByVal trans As SQLTransaction) As LogStatusData
        ...
        '/// Returns an indication whether the record of LOG_STATUS by specified STATUS_ORDER key is retrieved successfully.
        ...
        '/// Returns an indication whether the Data Class of LOG_STATUS by specified STATUS_ORDER key is retrieved successfully.
        '/// <param name=cSTATUS_ORDER>The STATUS_ORDER key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataBySTATUS_ORDER(ByVal cSTATUS_ORDER As Long, ByVal trans As SQLTransaction) As LogStatusData
            Return doGetMappingData("STATUS_ORDER = " & DB.SetDouble(cSTATUS_ORDER) & " ", trans)
        End Function

        '/// Returns an indication whether the record of LOG_STATUS by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of LOG_STATUS by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As LogStatusData, ByVal RDr As DataRow) As LogStatusData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As LogStatusData
            ClearData()
            _haveData = False
            Dim ret As New LogStatusData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table LOG_STATUS
        ...
        'Get update statement form table LOG_STATUS
        ...
        'Get Delete Record in table LOG_STATUS
        ...
        'Get Select Statement for table LOG_STATUS
