Namespace Common.Utilities
    Public Class Constant
        ...
        Partial Public Class SessionName
            Public Const MenuList = "MenuList"
        End Class

        Partial Public Class SysConfigName
            Public Const StatusOpen As String = "STATUS_OPEN"
            Public Const StatusClose As String = "STATUS_CLOSE"
            Public Const TypeIssue As String = "TYPE_ISSUE"
            Public Const TypeDefect As String = "TYPE_DEFECT"
            Public Const AdminID As String = "AdminID"
            Public Const PrapojID As String = "PrapojID"
        End Class
    End Class
