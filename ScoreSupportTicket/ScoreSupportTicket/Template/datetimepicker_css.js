  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (winCal == undefined) {
     ...
     // add javascript function to the span cal
       ...
       with (span.style) { position = "absolute"; left = (xpos + 8) + 'px'; top = (ypos - 8) + 'px'; width = CalWidth + 'px'; border = "solid 2pt " + SpanBorderColor; padding = "1pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 10000; }
