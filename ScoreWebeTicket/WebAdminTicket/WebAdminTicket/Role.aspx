...
<script type="text/javascript">
    ...
    //function auto fulltext search respon
    ...
    //function auto fulltext search project
    function SearchText() {
...
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
                ...
                <br />
                   ...
                   <telerik:RadGrid ID="RadGrid4" runat="server" AutoGenerateColumns="False" GridLines="None">
<MasterTableView>
<RowIndicatorColumn>
<HeaderStyle Width="20px"></HeaderStyle>
</RowIndicatorColumn>
    ...
    <Columns>
        <telerik:GridTemplateColumn UniqueName="TemplateColumn">
            <ItemTemplate>
                ...
                <asp:Label ID="Label16" runat="server" Text='<%# Eval("Row")%>'></asp:Label>
            </ItemTemplate>
        </telerik:GridTemplateColumn>
        <telerik:GridTemplateColumn UniqueName="TemplateColumn1">
             <ItemTemplate>
                <asp:Label ID="Label1" runat="server" Text='<%# Eval("project_code")%>'></asp:Label>
            </ItemTemplate>
        </telerik:GridTemplateColumn>
        ...
        <telerik:GridTemplateColumn UniqueName="TemplateColumn3">
             <ItemTemplate>
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("project_desc")%>'></asp:Label>
            </ItemTemplate>
        </telerik:GridTemplateColumn>
    </Columns>
</MasterTableView>
