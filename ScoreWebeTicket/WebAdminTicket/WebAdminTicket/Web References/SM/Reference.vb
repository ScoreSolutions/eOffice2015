...
Namespace SM
    ...
    Partial Public Class Service1
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WebTarget.My.MySettings.Default.WebTarget_SM_Service1
        ...
        Public Function SendEmail(ByVal strEmail As String, ByVal strTo As String) As String
            Dim results() As Object = Me.Invoke("SendEmail", New Object() {strEmail, strTo})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub SendEmailAsync(ByVal strEmail As String, ByVal strTo As String)
            Me.SendEmailAsync(strEmail, strTo, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub SendEmailAsync(ByVal strEmail As String, ByVal strTo As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("SendEmail", New Object() {strEmail, strTo}, Me.SendEmailOperationCompleted, userState)
        End Sub
