function IsAllDefined() { for (var a = 0; a < arguments.length; ++a) { if (typeof (arguments[a]) == "undefined") { return false } } return true } function asNum(a) { return parseInt(a, 10) || 0 } function getStyleAsNum(d, b, e) { var c = "0"; if (document.defaultView && document.defaultView.getComputedStyle) { c = asNum(document.defaultView.getComputedStyle(d, "").getPropertyValue(b)) } else { if (d.currentStyle) { c = asNum(d.currentStyle[e]) } } return asNum(c) } function GetWinH() { var b = 0; var a = 0; if ((!document.compatMode || document.compatMode == "CSS1Compat") && document.documentElement) { a = document.documentElement } else { if (document.body) { a = document.body } } if (a && a.clientHeight) { b = a.clientHeight } else { if (IsAllDefined(window.innerWidth, window.innerHeight, document.width)) { b = window.innerHeight; if (document.width > window.innerWidth) { b = b - 15 } } } return b } function GetWinW() {
...
} function GetObjectRect(e) { var a = 0; var g = 0; var f = e; var c = false; while (e && e != null) { if (e.style && e.style.position == "fixed") { c = true } a += asNum(isNS4 ? e.pageX : e.offsetLeft); g += asNum(isNS4 ? e.pageY : e.offsetTop); if (isNS4) { if (e.style && (e.style.position == "absolute" || e.style.position == "relative")) { break } } e = e.offsetParent } e = f; var b = 0; var d = 0; if (isOp && !isOp7) { b = e.style.pixelWidth } else { if (isNS4) { b = e.clip.width } else { b = e.offsetWidth } } if (isOp && !isOp7) { d = e.style.pixelHeight } else { if (isNS4) { d = e.clip.height } else { d = e.offsetHeight } } return { x: a, y: g, w: b, h: d, in_fixed: c } } function LoadSrcImage(b) { var a = new Image(); if (typeof isIE == "undefined") { GetBrowserInfo() } if (isIE && window.location.protocol == "file:") { a.meSrc = b } else { a.src = b } return a } function GetBrowserInfo() {
    isDOM = document.getElementById; isMz = isDOM && (navigator.appName == "Netscape"); isOp = isDOM && window.opera; isIE = document.all && document.all.item && !isOp;
    isIE6orLess = false; isIE8orLess = false; if (isIE) { var a = navigator.userAgent; var b = new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})"); if (b.exec(a) != null) { var c = parseFloat(RegExp.$1); isIE6orLess = (c <= 6); isIE8orLess = (c <= 8) } } isIE9 = isIE && document.documentMode >= 9; isNS4 = document.layers; isOp7 = isOp && document.readyState
} function GetViewRect() { var c = 0; var a = 0; if (isNS4 || isMz || isOp) { a = window.pageXOffset; c = window.pageYOffset } else { var b = (document.compatMode == "CSS1Compat" && !isMz) ? document.documentElement : document.body; a = b.scrollLeft; c = b.scrollTop } return { x: a, y: c, w: GetWinW(), h: GetWinH() } } function SetElemOpacity(a, b) {
    if (a && a.style) {
        if (b == 1) { a.style.opacity = ((navigator.userAgent.indexOf("Gecko") > -1) && !/Konqueror|Safari|KHTML/.test(navigator.userAgent)) ? 0.999999 : 1; if (isIE && !isIE9) { if (a.style.filter) { a.style.filter = a.style.filter.replace(/alpha\([^\)]*\)/gi, "") } } } else {
            if (b < 0.00001) { b = 0 } a.style.opacity = b; if (isIE && !isIE9) {
...
} function ebmMenuPosY(b, j, i, d, h, g, e) { var a = 5; var f = i; var k = h; var c = g; if (k > j - 2 * a && j > 0) { f = a + b; k = j - 2 * a } else { if (c == -1) { f = i + d - k + e } else { f = i } if (f < b + a) { f = b + a; c = 1 } if (f + h > j + b - a && j > 0) { f -= f + k - (j + b - a); c = -1 } } return { y: f, direction: c, size: k } } function ebmMenuPosX(c, d, i, k, b, h, f) { var a = 5; var g = i; var j = b; var e = h; if (((e >= 0) && (i + k + b > d + c - a)) || ((e < 0) && (i - b < a))) { if (i - c > d + c - (i + k) && d > 0) { e = -1 } else { e = 1 } } if (e >= 0) { g = i + k; if (d + c - a - g < j && d > 0) { j = d + c - a - g } } else { g = i - j + f; if (g - c < a) { g = c + a; j = i - (c + a) } } return { x: g, direction: e, size: j } } function ebmFade(b) {
    if (b) {
        var a = new Date().getTime(); var d = a - b.cbnLastAnimTime; var c = d / 200; if (c < 0.05 || b.cbnTransitionProgress == 0) { c = 0.05 } b.cbnTransitionProgress = c; if (b.cbnTransitionProgress > 1) { b.cbnTransitionProgress = 1 } if (b.ebmFadeEffect) { var e = b.cbnTransitionProgress; if (b.cbnMenuAlpha && e > b.cbnMenuAlpha) { e = b.cbnMenuAlpha } SetElemOpacity(b, e) } if (b.ebmScaleEffect > 0) { ebmProgressElementScale(b, b.cbnTransitionProgress) } if (b.cbnTransitionProgress >= 1) {
            clearInterval(b.ebmFadeTimer); b.ebmFadeTimer = null
        }
    }
} function ebmHideSubmenus() { if (cbnOpenTopMenu) { ebmRemoveSubmenu(cbnOpenTopMenu) } } function ebmDisplaySubmenu(h, c, f) {
    ...
    var a = b; if (a && (a.style.display == "block")) {
        if (a.openSubmenuDiv) { ebmRemoveSubmenu(a.openSubmenuDiv) } if (a.upperTR && a.upperTR.className) { a.upperTR.makeNormal() } a.style.display = "none"; a.openSubmenuDiv = 0; if (a.ticker) { clearTimeout(a.ticker); a.ticker = null } if (a.ebmFadeEffect || a.ebmScaleEffect) {
            if (a.ebmFadeEffect) {
                SetElemOpacity(a, 0)
            } if (ebmScaleEffect > 0) { ebmResetElementScale(a) } if (a.ebmFadeTimer) { clearTimeout(a.ebmFadeTimer); a.ebmFadeTimer = null }
        }
    }
        ...
        if (li.nodeName.toLowerCase() == "li") {
            if (depth != 0) {
                var itemLink = li.firstChild; while (itemLink) {
                    if (itemLink.nodeName.toLowerCase() == "a") {
                        if (itemLink.href && (!itemLink.target || itemLink.target.toLowerCase() == "_self")) {
                            itemLink.onclick = function (e) { if (!e) { var e = window.event } e.cancelBubble = true; if (e.stopPropagation) { e.stopPropagation() } }; if (itemLink.href.match(re)) {
                                li.rowClickLink = itemLink.href; li.onclick = function () {
                                    window.location.href = this.rowClickLink;
                                    return false
                                }
                            } else { if (itemLink.href.match(rejs)) { li.rowClickLink = itemLink.href; li.onclick = function () { eval(this.rowClickLink) } } }
                ...
                var lia; var itemLink = li.firstChild; while (itemLink) { if (itemLink.nodeName.toLowerCase() == "a") { lia = itemLink } itemLink = itemLink.nextSibling } if (lia) {
                    lia.parentli = li; var imgOver = false; var imgDown = false; var img = lia.firstChild;
                    while (img) { if (img.nodeName.toLowerCase() == "img") { if (img.className == "normalbutton") { lia.imgNormal = img; lia.imgNormalSrc = img.src } if (img.className == "hoverbutton") { lia.imgOverSrc = img.src; imgOver = img } if (img.className == "downbutton") { lia.imgDownSrc = img.src; imgDown = img } } img = img.nextSibling } if (imgOver) { lia.removeChild(imgOver) } if (imgDown) { lia.removeChild(imgDown) } if (!lia.href) { lia.onmouseover = function () { if (this.assocmenu) { meDoShow(this.assocmenu, this.ebmMenuDirection, this) } } } lia.onmouseover = function () { ebmAddRemoveClass(this.parentli, ["a", "div"], "itemhot", false); if (this.imgNormal && this.imgOverSrc) { var link = this.imgOverSrc; if (isIE && (window.location.protocol != "file:")) { link += "#" } this.imgNormal.src = link } }; lia.onmouseout = function () { ebmAddRemoveClass(this.parentli, ["a", "div"], "itemhot", true); ebmAddRemoveClass(this, ["a", "div"], "itemdown", true); if (this.imgNormal && this.imgNormalSrc) { this.imgNormal.src = this.imgNormalSrc } }; lia.onmousedown = function () {
                        ebmAddRemoveClass(this, ["a", "div"], "itemdown", false); if (this.imgNormal && this.imgDownSrc) {
                            this.imgNormal.src = this.imgDownSrc
                        }
                    }; lia.onmouseup = function () { ebmAddRemoveClass(this, ["a", "div"], "itemdown", true); if (this.imgNormal && this.imgOverSrc) { this.imgNormal.src = this.imgOverSrc } else { if (this.imgNormal && this.imgNormalSrc) { this.imgNormal.src = this.imgNormalSrc } } }
                ...
                if (ul.nodeName.toLowerCase() == "ul") {
                    ul.onmouseout = function () { meDoMouseOut(this) }; ul.onmouseover = function () { meDoMouseOver(this) }; ul.ebmFadeEffect = ebmFadeEffect; if (depth == 0) { ul.cbnMenuAlpha = cbnMenuAlpha } if (ebmFadeEffect) { SetElemOpacity(ul, 0) } else { if (cbnMenuAlpha) { SetElemOpacity(ul, ul.cbnMenuAlpha) } } ul.ebmScaleEffect = ebmScaleEffect;
                    if (ebmScaleEffect > 0) { ebmResetElementScale(ul) } ul.cbnDefaultDirectionX = cbnDefaultDirectionX; ul.upperTR = li; ul.depth = depth; ul.openSubmenuDiv = 0; li.assocmenu = ul; li.ebmMenuDirection = ebmMenuDirection; ebmGenerateTree(ul, li, depth + 1, className, idName); break
                } ul = ul.nextSibling
            }
        } li = li.nextSibling
    }
    ...
    GetBrowserInfo(); if (isMz && !cbnMenuAlpha && !ebmFadeEffect) { cbnMenuAlpha = 1 } if (isIE8orLess) { cbnMenuAlpha = 0 } var a = document.getElementsByTagName("ul"); for (var b = 0; b < a.length; b++) {
        if (a[b].id && a[b].id == ebmMenuName + "ebul_table" && a[b].className.substr(0, ebmMenuName.length + 13) == ebmMenuName + "ebul_menulist") {
            if (isIE6orLess) { a[b].style.overflow = "hidden" } ebmGenerateTree(a[b], 0, 0, ebmMenuName + "ebul_menulist", "ebul_" + ebmMenuName + "_mdiv"); a[b].className = a[b].className.replace("css_menu", "")
        }
    }
} var cbnOpenTopMenu = 0; var cbnMenuAlpha = 0.80; var ebmFadeEffect = true; var ebmScaleEffect = 1; var ebmMenuDirection = 0; var ebmMenuName = "mbmcp"; var cbnDefaultDirectionX = 1; InitEasyMenu();