                ...
                <asp:Button ID="btnclear" runat="server" Text="Clear" Width="65px" BackColor="#FF9933" Height="25px" />
                    ...
                    <tr>
                        ...
                        <td class="auto-style24">
                            <asp:TextBox ID="txtrtell" runat="server" Height="16px" Width="156px" MaxLength="20"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="auto-style24">
                            <asp:TextBox ID="txttell" runat="server" Width="157px" Height="19px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
