<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Customer.aspx.vb" Inherits="WebTarget.WebForm4" %>
    ...
    <telerik:RadGrid ID="RadGrid4" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" style="margin-top: 0px" PageSize="18" width="400px">
        ...
        <tr>
            ...
            <td class="auto-style22" colspan="3">
                    <br />
        <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" SelectedIndex="0" Font-Size="X-Large" Skin="Black" Height="19px" Width="453px" BackColor="#2B2B2B">
            <Tabs>
                <telerik:RadTab runat="server" Font-Size="20pt" Text="Branch" PageViewID="RadPageView1">
                </telerik:RadTab>
                <telerik:RadTab runat="server" Text="Contact Person" PageViewID="RadPageView2" Font-Size="20pt" >
                </telerik:RadTab>
                <telerik:RadTab runat="server" Text="Project" PageViewID="RadPageView3" Font-Size="20pt" Selected="True">
                </telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
        <telerik:RadMultiPage ID="RadMultiPage1" runat="server" Width="453px"  BackColor="#ccffff" SelectedIndex="0"><telerik:RadPageView ID="RadPageView1" runat="server" BackColor="#4E4E4E" Selected="true"><br /><table class="auto-style27"><tr><td class="auto-style115">Code :</td><td class="auto-style117"><asp:TextBox ID="txtbcode" runat="server" Width="110px" MaxLength="20"></asp:TextBox></td><td class="auto-style77"></td>
                    </tr>
                ...
                <br /><center><telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" Height="232px" PageSize="9" Skin="Black" Visible="False" Width="420px">
                     <ClientSettings>
                    ...
                    <mastertableview TableLayout="Fixed">
                        <rowindicatorcolumn>                        
                            ...
                            <Columns>
                                ...
                                <ItemStyle Width="70px" Wrap="true" VerticalAlign="Top" />
                ...
                <center><telerik:RadGrid ID="RadGrid7" runat="server" AutoGenerateColumns="False" GridLines="None" Width="400px"><mastertableview><rowindicatorcolumn>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        <telerik:GridTemplateColumn DataField="branch_id" HeaderText="No" UniqueName="TemplateColumn">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox7" runat="server" Enabled="false" Text='<%# Bind("branch_id")%>'></asp:TextBox></EditItemTemplate><ItemTemplate>
                <asp:Label ID="Label4" runat="server" Text='<%# Bind("branch_id")%>'></asp:Label></ItemTemplate></telerik:GridTemplateColumn><telerik:GridTemplateColumn HeaderText="B-Code" UniqueName="TemplateColumn1">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("branch_code")%>'></asp:TextBox></EditItemTemplate><ItemTemplate>
                <asp:Label ID="Label5" runat="server" Text='<%# Bind("branch_code")%>'></asp:Label></ItemTemplate></telerik:GridTemplateColumn><telerik:GridTemplateColumn HeaderText="B-Name" UniqueName="TemplateColumn2">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("branch_name")%>'></asp:TextBox></EditItemTemplate><ItemTemplate>
                <asp:Label ID="Label6" runat="server" Text='<%# Bind("branch_name")%>'></asp:Label></ItemTemplate></telerik:GridTemplateColumn><telerik:GridTemplateColumn HeaderText="Acc-No" UniqueName="TemplateColumn3">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox10" runat="server" Enabled="false" Text='<%# Bind("account_id")%>'></asp:TextBox></EditItemTemplate><ItemTemplate>
                <asp:Label ID="Label7" runat="server" Text='<%# Bind("account_id")%>'></asp:Label></ItemTemplate></telerik:GridTemplateColumn><telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmText="Are you sure you want to delete the selected row?" ImageUrl="Image/empty_bin.png" UniqueName="column">
                    <HeaderStyle BorderStyle="None" width="15px" />
                </telerik:GridButtonColumn>
...
<filtermenu enabletheming="True"><collapseanimation duration="200" type="OutQuint"></collapseanimation>
    ...
    <td class="auto-style68" style="text-align: left"><asp:TextBox ID="txtconE" runat="server" MaxLength="50" Width="110px"></asp:TextBox></td></tr><tr><td class="auto-style110">&#160;</td><td class="auto-style62">&#160;</td><td class="auto-style110" style="text-align: left">&#160;</td><td style="text-align: left"><asp:Button ID="Button2" runat="server" BackColor="#CC0000" BorderStyle="None" style="background-color: #3366FF" Text="Add" Width="53px" /></td>
                ...
                <Scrolling AllowScroll="True" UseStaticHeaders="True" SaveScrollPosition="true" FrozenColumnsCount="2"></Scrolling>
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="column" HeaderText="Code" ItemStyle-CssClass="breakWord">
                                ...
                                <ItemStyle Width="80px" Wrap="true" VerticalAlign="Top" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="column1" HeaderText="Name" ItemStyle-CssClass="breakWord">
                                <HeaderStyle Width="80px" Wrap="true" />
                                <ItemStyle Width="80px" Wrap="true" VerticalAlign="Top" />
                            ...
                            <telerik:GridBoundColumn DataField="column3" HeaderText="E-mail" ItemStyle-CssClass="breakWord">
                               <HeaderStyle Width="130px" Wrap="true" />
                                <ItemStyle Width="130px" Wrap="true" VerticalAlign="Top" />
                            </telerik:GridBoundColumn>
                             <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ImageUrl="Image/Delete.png" UniqueName="DelteColumn">                      
                                 <HeaderStyle Width="50px" Wrap="true" />
                                 <ItemStyle Width="50px" VerticalAlign="Top" HorizontalAlign="Left" />
                ...
                <center><telerik:RadGrid ID="RadGrid8" runat="server" AutoGenerateColumns="False" GridLines="None" Width="441px"><MasterTableView><RowIndicatorColumn>
<HeaderStyle Width="20px" />
</RowIndicatorColumn>
    ...
    <mastertableview TableLayout="Fixed"><rowindicatorcolumn>
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="column3" HeaderText="Suppervisor"  ItemStyle-CssClass="breakWord">
                             ...
                             <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ImageUrl="Image/Delete.png" UniqueName="DelteColumn">
                                 <HeaderStyle />
                                 <ItemStyle Width="50px" Wrap="true" VerticalAlign="Top" HorizontalAlign="Left" />
                                </telerik:GridButtonColumn>
                        </Columns>
                    </mastertableview>
