        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style5" >
                    <asp:Image ID="Image3" runat="server" Height="60px" ImageUrl="~/Image/km_03.png" Width="224px" />
                </td>
                <td class="auto-style6" rowspan="2" style="background-color:#CCCC00;" >&nbsp;</td>
                <td class="auto-style5">
                    <asp:Image ID="Image2" runat="server" Height="60px" ImageUrl="~/Image/time_03.png" Width="185px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style8" >
    ...
    <Columns>
        ...
        <telerik:GridTemplateColumn HeaderText="Time Left" UniqueName="TemplateColumn1" DataField="column">
            <ItemTemplate>
                ...
                <asp:Label ID="Label3" runat="server" Text="O'Clock" ForeColor="Red" ></asp:Label>
